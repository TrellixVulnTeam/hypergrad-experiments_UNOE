...
# using optimizers2 to plot gradient and step norms
#from hypergrad.optimizers import sgd4_mad as sgd4, rms_prop, adam
from hypergrad.optimizers2 import sgd4_mad_PCA as sgd4, rms_prop, adam
...
def run():
    ...
    def primal_optimizer(hyperparam_vect, i_hyper):
        # Michael: hyperparam_vect = hyperparams.vect
        # Michael: i_hyper = 0
