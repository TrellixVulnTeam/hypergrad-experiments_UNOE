# Michael: this is the MNIST dataset
import sys, os
...
from hypergrad.data import load_data_dicts #Michael: MNIST
from hypergrad.nn_utils import make_nn_funs, VectorParser, logit, inv_logit

#Michael: use modified algorithms for plots
#from hypergrad.optimizers import sgd4 as sgd4, rms_prop, adam
from hypergrad.optimizers2 import sgd4_PCA as sgd4, rms_prop, adam
...
# Michael: increase momentum
#init_invlogit_betas = inv_logit(0.5) #=0
init_invlogit_betas = inv_logit(0.95)
