...
def datapath(fname):
    #datadir = os.path.expanduser('../data') #Michael
    datadir = os.path.abspath('../../../data/omniglot') #Michael
    #/Users/Mike/Desktop/Vavasis/Hyperparameter_optimization/drmad-master_Mar5/cpu_ver/data    
