...
def setup():
    ...
    parser.add_argument('--maxEpochInit',
                        type=int, default=300) #100 and 160 previously; 10 if you don't have confidence in your initial guess
    ...
    parser.add_argument('--maxMaxEpoch',
                        type=int, default=5) #TODO: 300 from DenseNet on CIFAR10
    ...
    parser.add_argument('--momHyper',
                        type=float, default=0.7) #TODO: 0.7 for DrMAD
