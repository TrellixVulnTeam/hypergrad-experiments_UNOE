...
def setup():
    ...
    parser.add_argument('--maxEpochInit',
                        type=int, default=230) #100 and 160 previously; 10 if you don't have confidence in your initial guess
    ...
    parser.add_argument('--nBackwardMult',
                        type=float, default=0.2) #TODO: multiplies number of reverse iterations
    ...
    parser.add_argument('--nReversedIters',
                        type=int, default=20) #TODO: 5 in 100-5 or 120-5 online
                        # 20 for DrMAD2
